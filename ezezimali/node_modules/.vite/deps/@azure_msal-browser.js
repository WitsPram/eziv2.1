import {
  BridgeStatusCode
} from "./chunk-GYC7PGV7.js";
import {
  BrowserPerformanceMeasurement
} from "./chunk-H5HE5Q6L.js";
import {
  BrowserCacheManager,
...
async function createV3Controller(config) {
  ...
  const controller = await import("./StandardController-SN7XHTWK.js");
...
async function createController(config) {
  ...
  if (teamsApp.isAvailable() && teamsApp.getConfig().auth.supportsNestedAppAuth) {
    const controller = await import("./NestedAppAuthController-27MHVGZ5.js");
...
function getPerfMeasurementModule() {
  ...
  try {
    ...
    if (Number(perfEnabled) === 1) {
      return import("./BrowserPerformanceMeasurement-SYIWZNIN.js");
    }
  } catch (e) {
  }
  return void 0;
