...
async function createV3Controller(config) {
  ...
  const controller = await import("./StandardController-4P5ADOU6.js");
...
async function createController(config) {
  ...
  if (teamsApp.isAvailable()) {
    const controller = await import("./NestedAppAuthController-MLQGEJKW.js");
...
function getPerfMeasurementModule() {
  ...
  try {
    ...
    if (Number(perfEnabled) === 1) {
      return import("./BrowserPerformanceMeasurement-UFHN6BKU.js");
    }
  } catch (e) {
  }
  return void 0;
